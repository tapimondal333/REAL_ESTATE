...
const Testimonials = () => {
    return (
        <div className='container mx-auto py-10 lg:px-20 w-full overflow-hidden' id='Testimonials'>
            ...
            <div className='flex flex-wrap justify-center gap-6'>
                {testimonialsData.map((testimonial, index) => (
                    <div key={index} className='max-w-[340px] border shadow-lg rounded px-6 py-10 text-center'>
                        ...
                        <div className='flex justify-center gap-1 text-red-600 mb-4'>
                            {Array.from({length:testimonial.rating},(item,index)=>(
                                <img className='' key={index} src={assets.star_icon}></img>
                            ))}
                        </div>
